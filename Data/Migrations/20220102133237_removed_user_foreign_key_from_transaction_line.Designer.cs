...
namespace BlazorAccounting.Data.Migrations
{
    ...
    [Migration("20220102133237_removed_user_foreign_key_from_transaction_line")]
    partial class removed_user_foreign_key_from_transaction_line
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorAccounting.Data.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorAccounting.Data.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorAccounting.Data.TransactionLine", b =>
                {
                    b.HasOne("BlazorAccounting.Data.Account", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlazorAccounting.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
